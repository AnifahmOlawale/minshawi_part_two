...
Widget homeNavigationList({
  required bool playerListPage,
  required List<String> homeListTitle,
  required List<Icon> homeListIcons,
  required VoidCallback listController,
  required BannerAdsClass bannerAdsClass,
  required VoidCallback admobAds,
}) {
  return Visibility(
