...
Widget player(
    {required ThemeColor themeColorProvider, required QuranCsv quranCsv}) {
        ...
        children: [
          ...
          GestureDetector(
            onTap: () async {
              //
              //Save Clicked Index
              quranCsv.setCurrentSurahIndex(playerProvider.currentPlayerIndex!);
          ...
          Container(
            ...
            width: double.infinity,
            child: Text.rich(
              style: TextStyle(color: themeColorProvider.control, fontSize: 10),
              TextSpan(
                children: [
            ...
            children: [
              ...
              IconButton(
                ...
                icon: SwitchRepeat.repeatOFF.name ==
                    ...
                    : SwitchRepeat.repeatON.name == playerProvider.repeatingIcon
